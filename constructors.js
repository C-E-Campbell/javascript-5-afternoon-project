...
Movie.prototype.changeRating = function(num) {
	return (this.rating = this.rating / num);
};
////////// PROBLEM 5 //////////
...
User.prototype.removeSavedPost = function(id) {
	const removeMe = this.savedPosts.findIndex(post => post.id === id);
	this.savedPosts.splice(removeMe, 1);
};
////////// PROBLEM 7 //////////
...
User.prototype.changePostRating = function(id, rating) {
	const removeMe = this.savedPosts.findIndex(post => post.id === id);
	this.savedPosts[removeMe].rating = rating;
};
